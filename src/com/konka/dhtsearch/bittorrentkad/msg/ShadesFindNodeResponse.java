...
/**
 * A findNode response as defined in the kademlia protocol in shades, our response should contain a list of correctly shaded nodes.
 * 
 * @author Gil and Yoav we extend the find node response in order for nodes to be able to indicate if they are interested in the value for their cache.
 */
public class ShadesFindNodeResponse extends KadResponse {
	...
	protected ShadesFindNodeResponse(long id, Node src) {
		super(id, src);
	}
