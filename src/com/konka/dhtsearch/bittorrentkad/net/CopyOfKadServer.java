...
// * 
// */
//public class CopyOfKadServer implements Runnable {
//
...
//
//	public CopyOfKadServer(DatagramSocket socket, Bucket kadBuckets, Selector selector) {
//		this.socket = socket;
...
//							return;
//						} finally {
//							CopyOfKadServer.this.pkts.offer(pkt);// 如果可以，将ptk加入到队列
//						}
//					}
//
//				});
...
//		// e1.printStackTrace();
//		// }
//		MessageDispatcher dispatcher = new MessageDispatcher(timer, CopyOfKadServer.this, findNodeResponse.getTransaction());
...
//					
////							System.out.println("卡死="+byteBuffer.position());
//							byteBuffer.flip();
//							System.out.println(byteBuffer.limit());
//							byte[] dst = new byte[byteBuffer.position()];
//							byteBuffer.get(dst);
////							CharBuffer charBuffer = Charset.defaultCharset().decode(byteBuffer);
//							// charBuffer.g
////							System.out.println("receive message:--------" + charBuffer.toString());
//							byteBuffer.clear();
//							handleIncomingdata(target,dst);
//						}
//					}
//				}
//			} catch (Exception e) {
...
//	}
//
//	private void handleIncomingdata(SocketAddress target, byte[] dst) {
