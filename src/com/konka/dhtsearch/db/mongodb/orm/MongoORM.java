...
public class MongoORM {
	...
	public Collection<Object> populateDataStruct(Collection<Object> struct, Object data) throws Exception {
	...
	public <T> Object getObject(Class<T> clazz, DBObject dbObj) throws Exception {
		// System.out.println("Class: " + clazz);
		T realObj = clazz.newInstance();
		...
		for (Field f : fields) {
			...
			if (value instanceof BasicDBObject) {
				...
				if (c == List.class) {
					...
					Queue<Object> queue = (Queue<Object>) queueClass.newInstance();
	...
	public ObjectId saveRec(Object o) throws Exception {
		...
		for (Field f : fields) {
			...
			if (value instanceof Map) {
				...
				for (Object x : collec) {
					collectionAnnot = x.getClass().getAnnotation(MongoCollection.class);
				...
				Annotation collAnnot = clazzs.getAnnotation(MongoCollection.class);
